 ...
 * <ul>
 *   <li>{@link org.caltoopia.frontend.cal.impl.AstAnnotationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.caltoopia.frontend.cal.impl.AstAnnotationImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AstAnnotationImpl extends MinimalEObjectImpl.Container implements AstAnnotation
{
   ...
   * @ordered
   */
  protected EList<AstAnnotationArgument> arguments;
   ...
   * @generated
   */
  public EList<AstAnnotationArgument> getArguments()
  {
    if (arguments == null)
    {
      arguments = new EObjectContainmentEList<AstAnnotationArgument>(AstAnnotationArgument.class, this, CalPackage.AST_ANNOTATION__ARGUMENTS);
    }
    return arguments;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case CalPackage.AST_ANNOTATION__ARGUMENTS:
        getArguments().clear();
        getArguments().addAll((Collection<? extends AstAnnotationArgument>)newValue);
        return;
    }
