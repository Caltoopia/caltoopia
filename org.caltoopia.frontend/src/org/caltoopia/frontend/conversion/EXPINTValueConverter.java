...
/**
 * This class defines a value converter for exponential int rule.
 * 
 * @author Matthieu Wipliez
 */
public class EXPINTValueConverter extends AbstractLexerBasedConverter<Long> {

	public EXPINTValueConverter() {
		super();
	}
