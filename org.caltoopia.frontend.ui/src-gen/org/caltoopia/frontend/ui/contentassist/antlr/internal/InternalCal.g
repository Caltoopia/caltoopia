...
:
(
{ before(grammarAccess.getAstExpressionSymbolReferenceAccess().getLeftParenthesisKeyword_4_0()); }

	'(' 

{ after(grammarAccess.getAstExpressionSymbolReferenceAccess().getLeftParenthesisKeyword_4_0()); }
)
