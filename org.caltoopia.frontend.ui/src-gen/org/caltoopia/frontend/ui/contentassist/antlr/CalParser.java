		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAstAnonymousConstructorAccess().getGroup(), "rule__AstAnonymousConstructor__Group__0");
					put(grammarAccess.getAstAnonymousConstructorAccess().getGroup_1(), "rule__AstAnonymousConstructor__Group_1__0");
					put(grammarAccess.getAstAnonymousConstructorAccess().getGroup_1_1(), "rule__AstAnonymousConstructor__Group_1_1__0");
					put(grammarAccess.getAstAnonymousConstructorAccess().getGroup_1_1_1(), "rule__AstAnonymousConstructor__Group_1_1_1__0");
					...
					put(grammarAccess.getAstExpressionPostfixAccess().getGroup_4(), "rule__AstExpressionPostfix__Group_4__0");
					...
					put(grammarAccess.getAstTypeNameAccess().getGroup_0(), "rule__AstTypeName__Group_0__0");
					...
					put(grammarAccess.getAstTypeDefinitionAccess().getConstructorAssignment_4_0(), "rule__AstTypeDefinition__ConstructorAssignment_4_0");
					put(grammarAccess.getAstTypeDefinitionAccess().getConstructorAssignment_4_1_0(), "rule__AstTypeDefinition__ConstructorAssignment_4_1_0");
					put(grammarAccess.getAstTypeDefinitionAccess().getConstructorAssignment_4_1_1_1(), "rule__AstTypeDefinition__ConstructorAssignment_4_1_1_1");
					...
					put(grammarAccess.getAstAnonymousConstructorAccess().getMembersAssignment_1_1_0(), "rule__AstAnonymousConstructor__MembersAssignment_1_1_0");
					put(grammarAccess.getAstAnonymousConstructorAccess().getMembersAssignment_1_1_1_1(), "rule__AstAnonymousConstructor__MembersAssignment_1_1_1_1");
